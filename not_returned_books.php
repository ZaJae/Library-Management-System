...
<head>
    <meta charset="UTF-8">
    <title>My Account - Not Returned</title>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <div class="menu-links">
                ...
                <a href="issued_books.php" class="<?php echo $currentPage === 'issued' ? 'active' : ''; ?>">Issued</a>
                <a href="returned_books.php" class="<?php echo $currentPage === 'returned' ? 'active' : ''; ?>">Returned</a>
                <a href="not_returned_books.php" class="<?php echo $currentPage === 'not_returned' ? 'active' : ''; ?>">Not Returned</a>
                <a href="balance.php" class="<?php echo $currentPage === 'balance' ? 'active' : ''; ?>">Balance</a>
            </div>
